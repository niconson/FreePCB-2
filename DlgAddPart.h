...
public:
	...
	afx_msg void OnCbnDropdownEditValue();
	afx_msg void OnCbnSelchangeEditValue();
//	afx_msg void OnCbnSelendokEditValue();
//	afx_msg void OnCbnEditupdateEditValue();
//	afx_msg void OnCbnEditchangeEditValue();
};

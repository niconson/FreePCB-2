...
void CAboutDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	if( !pDX->m_bSaveAndValidate )
	{
		...
		// VERSION (key)
#ifdef _DEBUG
		m_edit_build.SetWindowText("2.4 Debug: 19   e-mail: freepcb@niconson.com"/* // VERSION "$WCREV$ Debug: ($WCDATE$)" */ );
#else
		m_edit_build.SetWindowText( "2.4 Release: 19   e-mail: freepcb@niconson.com"/* "$WCREV$ Debug: ($WCDATE$)" */ );
#endif
	}
}
